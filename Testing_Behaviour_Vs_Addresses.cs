...
public class TestingBehaviourVsAddresses
{
    ...
    public class AddressTests
    {
        ...
        public void Test_Two_Instances_Of_Same_Object_Are_Not_Equal()
        {
            unsafe
            {
                object house1 = new object();
                object house2 = new object();
                output.WriteLine($"House object's address: {house1}");
                output.WriteLine($"House object's address: {house2}");
        ...
        public void Test_Instance_And_Reference_To_Instance_Are_Equal()
        {
            unsafe
            {
                object house = new object();
                object houseReference = house;
                output.WriteLine($"House object's address: {house}");
                output.WriteLine($"House object's address: {houseReference}");
        ...
        public void Test_House_numberOfRooms_Equals_House_Instance_numberOfRooms()
        {
            unsafe
            {
                ...
                output.WriteLine($"House object reference's address: {houseReference.numberOfRooms}");
        ...
        public void Test_Two_Instances_Of_House_With_Same_Instance_Of_Room_Have_Same_Room()
        {
            unsafe
            {
                ...
                output.WriteLine($"House A myRoom object: {houseA.room.guestName}");
                output.WriteLine($"House B myRoom object: {houseB.room.guestName}");
